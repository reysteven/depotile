<div class="modal fade" id="myModalImportExportAddon" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:50%">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#224098; color:white">
                ...
                <h4 class="title text-center">Import/Export Add On Data</h4>
            </div>
            <div class="modal-body row" style="color:black">
                ...
                <div class="content">
                    <div class="col-xs-12">
                        <p style="text-align:justify">This menu is used to do both data import or data export in excel format. You should export existing data first <a href="{{ url('doExportAddon') }}" id="export-excel-link" target="_blank">here</a> so you know the table format and the existing data, but if you're already sure with excel that will be imported, you can import your excel below.</p>
                        <form method="POST" id="excel-uploader-form" action="{{ url('doUploadAddon') }}" enctype="multipart/form-data">
